...
const blogPosts = [
  [
    ...
    "When sciatica changes your day",
    "Pain & movement",
    "A practical way to prepare for a condition-focused massage conversation.",
  ],
  [
    "jaw-tension-and-tmj",
    "Jaw tension, TMJ, and the everyday habits that add up",
    "Head, neck & jaw",
    "What to notice before you talk with a therapist about persistent jaw tension.",
  ],
  [
    "recovery-after-surgery",
    "Planning gentle support after surgery",
    "Recovery",
    "Questions to bring to your care team when movement and comfort are changing.",
  ],
  [
    "plantar-fasciitis",
    "A thoughtful approach to plantar-fascia discomfort",
    "Feet & movement",
    "How to describe the patterns that make each step feel different.",
  ],
  [
    "why-trigger-points-matter",
    "Why trigger points matter",
    "Treatment education",
    "A plain-language introduction to targeted soft-tissue work.",
  ],
  [
    "making-a-return-visit-easier",
    "Making a return visit feel manageable",
    "Practice notes",
    "Small planning details can make ongoing care easier to fit into real life.",
  ],
];
